...
extract($_POST);
$con=mysqli_connect('localhost','root','','db_codar');
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Administrator Codar</b></span>
                </a>
            ...
            ?>
                ...
                <footer class="main-footer">
                    ...
                    <strong>Copyright &copy; 2016 <a href="http://coding-arena.id/">The Biggest Forum Programer</a>.</strong> All rights reserved.
                </footer>
